     ...
     return(
        <div className="border-b flex justify-between items-center px-16 py-2">
                <div className="flex gap-4 items-center">
                    <Link to = "/blogs"><div className="cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="50px" height="50px" viewBox="0 -55 256 256" version="1.1" preserveAspectRatio="xMidYMid">
    <g>
